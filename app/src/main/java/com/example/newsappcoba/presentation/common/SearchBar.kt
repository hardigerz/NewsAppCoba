...
import com.example.newsappcoba.utils.Dimens.IconSize
...
fun SearchBar(
    ...
    Box(modifier = Modifier.padding(top = MediumPadding1, start = MediumPadding1, end = MediumPadding1, bottom = MediumPadding1)
    .statusBarsPadding()) {
        TextField(
            modifier = Modifier
                .fillMaxWidth()
